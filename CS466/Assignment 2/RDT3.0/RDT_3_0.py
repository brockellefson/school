...
class RDT:
    ...
    def rdt_3_0_send(self, msg_S):
        ...
        while True:
            ...
            while rcvpkt == '' and timeoutend - timeoutstart < wait: #waiting for response from reciever, timeout = 5
                rcvpkt = self.network.udt_receive() #response equals whatever the reciever responds
                timeoutend = time.time()
            if rcvpkt == '':
                continue #timedout, resend packet
    ...
    def rdt_3_0_receive(self):
        ...
        while True:
            ...
            if Packet.corrupt(self.byte_buffer):
                ...
                if rcvpkt.msg_S != '1': #if this packet is not an ACK
