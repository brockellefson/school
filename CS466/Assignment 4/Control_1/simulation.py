...
if __name__ == '__main__':
    ...
    for i in range(1):
        client.udt_send(2, 'Put your hands to the constellations %d' % i) #send a fire bar
        server.udt_send(1, 'The way you look should be a sin, you my sinsation %d' % i) #send a fire reponse
