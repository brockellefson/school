...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H2' : 'H2Frame'}
    frwd_tbl_D = {'H1' : 0 , 'H2Frame' : 1}
    decap_tbl_D = {'H1Frame' : 'H1'}
    ...
    encap_tbl_D = {'H1' : 'H1Frame'}    # table used to encapsulate network packets into MPLS frames
    frwd_tbl_D = {'H1Frame' : 0, 'H2' : 1}     # table used to forward MPLS frames
    decap_tbl_D = {'H2Frame' : 'H2'}    # table used to decapsulate network packets from MPLS frames
