...
\begin{figure}[h]
  \includegraphics[width=\linewidth]{dfa3.png}
  \caption{ $\{$w$\mid$w contains the substring 0101 $($i.e., w = x0101y for some x and y$)$$\}$}
  \label{fig:dfa3}
\end{figure}

\begin{figure}[h]
  \includegraphics[width=\linewidth]{dfa42.png}
